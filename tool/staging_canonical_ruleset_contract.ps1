...
try {
  ...
  $applied = @(Compare-Object $actual @($expected + '202609070056')).Count -eq 0 -or
    ...
    @(Compare-Object $actual @($expected + @('202609070056','202609070057','202609080058','202609080059','202609090060','202609090061','202609090062','202609090063','202609090064','202609090065','202609100066'))).Count -eq 0
