...
try {
  ...
  $applied = @(Compare-Object $actual @($expected + '202609070052')).Count -eq 0 -or
    ...
    @(Compare-Object $actual @($expected + @('202609070052','202609070053','202609070054','202609070055','202609070056','202609070057','202609080058','202609080059','202609090060','202609090061'))).Count -eq 0
