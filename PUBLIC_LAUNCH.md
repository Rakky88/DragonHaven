...
Huidige openbare appversie bij deze controle: **v0.04.13**
...
- Bij de v0.04.13-release waren alle 27 database-migraties gelijk, waren er
...
- De releaseworkflow bouwt aantoonbaar een Play-ready, vast ondertekende AAB
  ...
  [33305564413](https://github.com/Rakky88/DragonHaven/actions/runs/33305564413)
  was volledig groen voor v0.04.13 met 302 tests.
...
Let op: de openbare APK van v0.04.13 is **339.962.464 bytes** (ongeveer
324,2 MiB), met SHA-256
`ec98434a99feafa2780561b494847763e4278169b6c58b0d769af8c060edbff3`.
