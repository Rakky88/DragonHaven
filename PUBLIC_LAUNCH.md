...
Huidige openbare appversie: **v0.05.23 / 10073**, via GitHub Releases.
Android package name: **`nl.dragonhaven.app`**

De release, 689 tests, signing en productiehealth zijn gecontroleerd in
[RELEASE_V0.05.23_VERIFICATION.md](RELEASE_V0.05.23_VERIFICATION.md).
