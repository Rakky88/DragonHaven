...
Release-status bijgewerkt: **9 september 2026**

Huidige openbare appversie: **v0.05.24 / 10074**, via GitHub Releases.
Android package name: **`nl.dragonhaven.app`**

De release, 701 tests, signing en productiehealth zijn gecontroleerd in
[RELEASE_V0.05.24_VERIFICATION.md](RELEASE_V0.05.24_VERIFICATION.md).
