...
void main() {
  ...
  LatestRelease newerRelease() => const LatestRelease(
        tagName: 'v0.05.15',
        pageUrl: 'https://github.com/Rakky88/DragonHaven/releases/tag/v0.05.15',
        downloadUrl:
            'https://github.com/Rakky88/DragonHaven/releases/download/v0.05.15/DragonHaven.apk',
        hasApk: true,
      );
  ...
  testWidgets('registered keepers see one dismissible prompt for a newer app',
    ...
    expect(find.text('v0.05.14'), findsOneWidget);
    expect(find.text('v0.05.15'), findsOneWidget);
    expect(checks, 1);
