...
void main() {
  test('Pride and Valentine grades include each new boundary exactly', () {
    for (final entry in {
      TrialKind.prismaticParade: [1200, 2900, 4800, 7200, 10000],
      TrialKind.rosevowRelay: [650, 1600, 2600, 3900, 5500],
      TrialKind.witchlightWard: [500, 1200, 2000, 2250, 2500],
    }.entries) {
  ...
  test('arcade acceleration has playable floors and bounded expertise help',
    ...
    expect(SeasonalArcadePacing.parcelLifetime(180, -1), 1.15);
    expect(SeasonalArcadePacing.parcelLifetime(180, 100), closeTo(2.05, .001));
