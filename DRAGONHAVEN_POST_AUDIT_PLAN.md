...
Actuele lokale tranche: **v0.05.00 is als releasecandidate voorbereid met
versionCode 10050 en productie staat nog veilig op 29/29 migraties. Friend
Messages, Conclaves, de Supporter-correcties en exacte Android-notificatietiming
zijn lokaal groen op analyzer, 347/347 tests en een correct ondertekende
productie-APK. Migratie 30, staging en de openbare release worden nu via de
expliciet toegestane releasegates uitgerold.**
...
## Releasecandidate v0.05.00

Deze tabel scheidt de lokaal afgeronde implementatie bewust van wat pas met een
nieuwe, expliciet toegestane server- en releaseronde bewezen kan worden.

| Onderdeel | Lokaal klaar | Nog door Codex | Nog door jou |
| --- | --- | --- | --- |
| Friend Messages | Vriend-naar-vriendchat, 24-uursweergave, ontvangen toestaan/weigeren, aparte notificatiecategorie, logische deep-link, ongelezen teller, lichte chatpoll en server-side friendship/rate-limitcontrole | Migratie 30 op geïsoleerde staging linten en met twee accounts E2E bewijzen: sturen, lezen, ongelezen status, opt-out, notificatie-ack en cleanup; daarna productiepreflight herhalen | Release-, staging- en productietoestemming is op 31 augustus gegeven; geen nieuw account of betaalde dienst nodig |
| Conclaves | 4–20 leden, Public/Request/Invite Only, Flightmaster/Warden/Keeper, 20 emblemen, unieke permanente naam, chat en deelkaarten, Conclave Chronicle, achievement-opt-in, dagelijkse Aerie-bijdrage, 50 levels en 10 Aerie-fasen | De uitgebreide twee-account stagingflow bewijst unieke naamnormalisatie, join, Warden-rang, chat, Aerie-bijdrage en cleanup; daarna alleen migratie 30 via de exact begrensde 29→30-workflow uitrollen | Release-, staging- en productietoestemming is gegeven; gewenste Conclave-balans na praktijktest beoordelen |
| Sociale sprites en lokalisatie | Eén eigen berichtenicoon, 20 afzonderlijke emblemen en 10 Aerie-sprites met echte alpha en veiligheidsmarges; alle vaste nieuwe UI-teksten bestaan in acht ondersteunde talen | De schermen op compacte en grote Android-emulators nalopen zodra de serverflow op staging beschikbaar is | Alleen visuele feedback geven als je later een andere stijl of balans wilt |
| Serverveiligheid | Directe tabeltoegang ingetrokken, RLS op alle nieuwe tabellen, uitsluitend afgeschermde RPC's, row locks op capaciteit, maximaal twintig bijdragen per UTC-dag, automatische Flightmaster-opvolging en vijfminuten-Cron voor tijdelijke chatdata | Echte Supabase database-lint/preflight en recovery/cleanup-E2E op staging uitvoeren; productie blijft onaangeraakt tot aparte toestemming | Geen configuratie nodig; alleen de bestaande expliciete migratie- en releasegoedkeuring blijft vereist |
...
| 31-08-2026 | Release 0.05.00 | Broncode, staging, productiemigratie 30 en de nieuwe apprelease zijn expliciet toegestaan | Friend Messages en Conclaves plus de notificatie- en Supporter-correcties als serverveilige hoofdversie uitrollen | Uitrol uitsluitend na groene 347-testgate, uitgebreide twee-account staging-E2E, begrensde migratie 29→30, dubbele releasegate en post-release healthcheck; echte aankopen blijven uitgeschakeld |
