...
- All ten school games now have their own illustrated background, icon and
  sprite-based play pieces. Two overly similar lessons were replaced with
  Cloud Weave and Constellation Trace.
- Every dragon receives three official attempts per lesson. Its best score and
  stars count toward a final report after all 30 attempts: Dropout, Graduate,
...
- The Founding Supporter Pack presentation has a new Packs sprite, expandable
  contents and a clearer in-card purchase action. Its portrait, title, badge,
  frame and furniture remain separate from chest odds and normal collections.
- The top-right menu now follows the requested Account Info, Language,
  Achievements, Keeper Journal and Tutorial order. The seven-day Trial
  constellation is more compact and uses illustrated nodes.
- Save schema 47 stores school attempts safely. Existing school records and
  stars remain intact and receive three official attempts per lesson.
- This release adds no Supabase migration. Production remains on all 28
  existing migrations and real-money purchases remain disabled until verified
  Google Play billing is connected server-side.
