...
$localArtifact = Get-Content release/v0.05.18-artifact.json -Raw | ConvertFrom-Json
$release = (& 'C:/Program Files/GitHub CLI/gh.exe' api repos/Rakky88/DragonHaven/releases/tags/v0.05.18 | Out-String) | ConvertFrom-Json
if ($LASTEXITCODE -ne 0 -or $release.tag_name -ne 'v0.05.18' -or $release.draft) { throw 'Expected public release not found.' }
...
if ($LASTEXITCODE -ne 0 -or $latest.tag_name -ne 'v0.05.18') { throw 'Latest points at the wrong release.' }
