...
extension GameIconKindAsset on GameIconKind {
  String get assetPath {
    if (this == GameIconKind.friendsMessage) {
      return 'assets/images/ui/friends_message.png';
    }
    return 'assets/images/ui/ui_${switch (this) {
      ...
      GameIconKind.friendsMessage => 'friends_message',
