...
const achievementCatalog = <AchievementDefinition>[
  ...
  AchievementDefinition(
      id: 'warden_of_the_witchlight',
      titleEn: 'Warden of the Witchlight',
      titleNl: 'Wachter van het Heksenlicht',
      descriptionEn: 'Hatch Gloamgourd from a Witchlight Egg.',
      descriptionNl: 'Laat Gloamgourd uit een Heksenlicht-ei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
      badge: 'warden_witchlight.webp'),
  AchievementDefinition(
      id: 'star_in_every_hearth',
      titleEn: 'A Star in Every Hearth',
      titleNl: 'Een Ster in Elke Haard',
      descriptionEn: 'Hatch Hollyfrost from a Starlit Evergreen Egg.',
      descriptionNl: 'Laat Hollyfrost uit een Sterrenlicht-dennenei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
      badge: 'star_every_hearth.webp'),
  AchievementDefinition(
      id: 'first_light_first_flight',
      titleEn: 'First Light, First Flight',
      titleNl: 'Eerste Licht, Eerste Vlucht',
      descriptionEn: 'Hatch Dawnchime from a Turning-Year Egg.',
      descriptionNl: 'Laat Dawnchime uit een Jaarwende-ei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
      badge: 'first_light_first_flight.webp'),
  AchievementDefinition(
      id: 'two_hearts_one_flight',
      titleEn: 'Two Hearts, One Flight',
      titleNl: 'Twee Harten, Eén Vlucht',
      descriptionEn: 'Hatch Rosevow from a Rosebound Egg.',
      descriptionNl: 'Laat Rosevow uit een Rozenverbonden Ei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
      badge: 'two_hearts_one_flight.webp'),
  AchievementDefinition(
      id: 'every_color_takes_flight',
      titleEn: 'Every Color Takes Flight',
      titleNl: 'Elke Kleur Krijgt Vleugels',
      descriptionEn: 'Hatch Spectrumplume from a Truecolor Egg.',
      descriptionNl: 'Laat Spectrumplume uit een Ware-Kleuren-ei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
      badge: 'every_color_takes_flight.webp'),
  AchievementDefinition(
      id: 'probably_fine',
  ...
  AchievementDefinition(
      ...
      descriptionEn: 'Help one dragon successfully complete Dragon Academy.',
      descriptionNl: 'Help één draak de Drakenacademie succesvol afronden.',
      target: 1,
      category: AchievementCategory.master,
      badge: 'academy_graduate'),
  AchievementDefinition(
      id: 'dragon_school_dropout',
      titleEn: 'Dragon Academy Dropout',
      titleNl: 'Drakenacademie-uitvaller',
      descriptionEn:
  ...
  AchievementDefinition(
      ...
      descriptionEn: 'Help one dragon finish Dragon Academy with all 30 stars.',
      descriptionNl:
          'Help één draak de Drakenacademie met alle 30 sterren afronden.',
      target: 1,
      category: AchievementCategory.master,
      badge: 'dragon_school_valedictorian'),
  AchievementDefinition(
      id: 'beneath_the_harvest_moon',
      titleEn: 'Beneath the Harvest Moon',
      titleNl: 'Onder de Oogstmaan',
      descriptionEn: 'Hatch Ciderhorn from a Moonorchard Egg.',
      descriptionNl: 'Laat Ciderhorn uit een Maanboomgaard-ei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
      badge: 'beneath_the_harvest_moon.png'),
  AchievementDefinition(
      id: 'light_across_the_lagoon',
      titleEn: 'Light Across the Lagoon',
      titleNl: 'Licht over de Lagune',
      descriptionEn: 'Hatch Solmanta from a Sunpearl Egg.',
      descriptionNl: 'Laat Solmanta uit een Zonneparel-ei komen.',
      target: 1,
      category: AchievementCategory.master,
      secret: true,
