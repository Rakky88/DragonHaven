-- Trial personal bests are published as read-only social showcase data.
alter table public.social_showcases
  add column cavern_flight_best integer not null default 0
    check (cavern_flight_best between 0 and 1000000000),
  add column ruin_breaker_best integer not null default 0
    check (ruin_breaker_best between 0 and 1000000000),
  add column runeweaver_best integer not null default 0
    check (runeweaver_best between 0 and 1000000000),
  add column favorite_dragon_cavern_flight_best integer
    check (favorite_dragon_cavern_flight_best between 0 and 1000000000),
  add column favorite_dragon_ruin_breaker_best integer
    check (favorite_dragon_ruin_breaker_best between 0 and 1000000000),
  add column favorite_dragon_runeweaver_best integer
    check (favorite_dragon_runeweaver_best between 0 and 1000000000);
