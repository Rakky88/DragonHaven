-- Three-strike endings for Witchlight, Giftforge and Midnight Chime.
-- Existing timing, ownership, score caps, leaderboard isolation and one-use rules remain.
...
begin
  ...
  if p_score is null or p_correct_actions is null or p_total_actions is null
     ...
     or (p_duration_ms < 30000 and not (attempt.trial_key in ('witchlightWard', 'hollyfrostGiftforge', 'midnightChime')
