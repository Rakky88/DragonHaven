-- All verified keepers can activate the catalog previews for their own account.
-- Preserve the lock, retry expiry, single preview and existing reward provenance.
